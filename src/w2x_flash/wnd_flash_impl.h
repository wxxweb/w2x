...
class IExtApiXmlParser {
public:
	IExtApiXmlParser(void) {}
	virtual ~IExtApiXmlParser(void) {}
public:
	virtual bool ParseExtApiXml(LPCTSTR _xml) = 0;
};
...
public:
	bool SetWndName(LPCTSTR _name);
	LPCTSTR GetWndName(void) const;
	...
	inline void SetExtApiXmlParser(IExtApiXmlParser& _parser);
...
private:
	...
	IExtApiXmlParser* m_ext_api_xml_parser;
};
...
inline void CWndFlashImpl::SetExtApiXmlParser(IExtApiXmlParser& _parser)
{
	m_ext_api_xml_parser = &_parser;
}
