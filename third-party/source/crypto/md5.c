 ...
 */
W2X_CRYPTO_API void MD5Init (mdContext)
MD5_CTX *mdContext;
{
 ...
 */
W2X_CRYPTO_API void MD5Update (mdContext, inBuf, inLen)
MD5_CTX *mdContext;
unsigned char *inBuf;
unsigned int inLen;
{
 ...
 */
W2X_CRYPTO_API void MD5Final (mdContext)
MD5_CTX *mdContext;
{
  UINT4 in[16];
  int mdi;
 ...
 */
W2X_CRYPTO_API void MD5Transform (buf, in)
UINT4 *buf;
UINT4 *in;
{
