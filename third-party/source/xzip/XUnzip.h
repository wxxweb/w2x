...
XEXTERN ZRESULT GetZipItemA(HZIP hz, int index, ZIPENTRY *ze);
XEXTERN ZRESULT GetZipItemW(HZIP hz, int index, ZIPENTRYW *ze);
...
XEXTERN ZRESULT FindZipItemA(HZIP hz, const TCHAR *name, bool ic, int *index, ZIPENTRY *ze);
XEXTERN ZRESULT FindZipItemW(HZIP hz, const TCHAR *name, bool ic, int *index, ZIPENTRYW *ze);
...
XEXTERN ZRESULT UnzipItem(HZIP hz, int index, void *dst, unsigned int len, DWORD flags);
...
XEXTERN HZIP OpenZipU(void *z,unsigned int len,DWORD flags);
XEXTERN ZRESULT CloseZipU(HZIP hz);
XEXTERN unsigned int FormatZipMessageU(ZRESULT code, char *buf,unsigned int len);
XEXTERN bool IsZipHandleU(HZIP hz);
